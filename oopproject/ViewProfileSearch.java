 ...
 * @author zubi1
 */
public class ViewProfileSearch extends javax.swing.JFrame {

    /**
     * Creates new form ViewProfileSearch
     */
    public ViewProfileSearch() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewProfileSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewProfileSearch().setVisible(true);
            }
        });
    }
